...
/obj/machinery/computer/prisoner
	...
	serialize()
		var/list/data = ..()
		data["inserted_id"] = locateUID(inserted_id_uid)?.serialize()
		return data

	deserialize(list/data)
		var/inserted_id = locateUID(inserted_id_uid)
		qdel(inserted_id)
		var/obj/item/card/id/prisoner/I = list_to_object(data["inserted_id"], src)
		if(istype(I))
			I.forceMove(src)
